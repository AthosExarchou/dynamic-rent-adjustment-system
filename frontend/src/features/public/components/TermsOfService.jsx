...
export default function TermsOfService() {
  ...
  const scrollToSection = (e, id) => {
    ...
    if (sectionRefs[id].current) {
      window.scrollTo({
        top: sectionRefs[id].current.offsetTop - 100,
        behavior: 'smooth'
      });
      setActiveSection(id);
    }
      ...
      <div className={styles.layout}>
        <aside className={styles.sidebar}>
          <nav className={styles.nav}>
            <a href="#section1" className={`${styles.navLink} ${activeSection === 'section1' ? styles.active : ''}`} onClick={(e) => scrollToSection(e, 'section1')}>1. Agreement to Terms</a>
            <a href="#section2" className={`${styles.navLink} ${activeSection === 'section2' ? styles.active : ''}`} onClick={(e) => scrollToSection(e, 'section2')}>2. User Accounts</a>
            <a href="#section3" className={`${styles.navLink} ${activeSection === 'section3' ? styles.active : ''}`} onClick={(e) => scrollToSection(e, 'section3')}>3. Use of the Service</a>
            <a href="#section4" className={`${styles.navLink} ${activeSection === 'section4' ? styles.active : ''}`} onClick={(e) => scrollToSection(e, 'section4')}>4. User-Generated Content</a>
            <a href="#section5" className={`${styles.navLink} ${activeSection === 'section5' ? styles.active : ''}`} onClick={(e) => scrollToSection(e, 'section5')}>5. Intellectual Property</a>
            <a href="#section6" className={`${styles.navLink} ${activeSection === 'section6' ? styles.active : ''}`} onClick={(e) => scrollToSection(e, 'section6')}>6. Disclaimers</a>
            <a href="#section7" className={`${styles.navLink} ${activeSection === 'section7' ? styles.active : ''}`} onClick={(e) => scrollToSection(e, 'section7')}>7. Limitation of Liability</a>
            <a href="#section8" className={`${styles.navLink} ${activeSection === 'section8' ? styles.active : ''}`} onClick={(e) => scrollToSection(e, 'section8')}>8. Termination</a>
            <a href="#section9" className={`${styles.navLink} ${activeSection === 'section9' ? styles.active : ''}`} onClick={(e) => scrollToSection(e, 'section9')}>9. Governing Law</a>
            <a href="#section10" className={`${styles.navLink} ${activeSection === 'section10' ? styles.active : ''}`} onClick={(e) => scrollToSection(e, 'section10')}>10. Changes to Terms</a>
            <a href="#section11" className={`${styles.navLink} ${activeSection === 'section11' ? styles.active : ''}`} onClick={(e) => scrollToSection(e, 'section11')}>11. Contact Us</a>
          </nav>
        </aside>

        <main className={styles.mainContent}>
          <section id="section1" ref={sectionRefs.section1} className={styles.section}>
          ...
          <section id="section2" ref={sectionRefs.section2} className={styles.section}>
          ...
          <section id="section3" ref={sectionRefs.section3} className={styles.section}>
          ...
          <section id="section4" ref={sectionRefs.section4} className={styles.section}>
          ...
          <section id="section5" ref={sectionRefs.section5} className={styles.section}>
          ...
          <section id="section6" ref={sectionRefs.section6} className={styles.section}>
          ...
          <section id="section7" ref={sectionRefs.section7} className={styles.section}>
          ...
          <section id="section8" ref={sectionRefs.section8} className={styles.section}>
          ...
          <section id="section9" ref={sectionRefs.section9} className={styles.section}>
          ...
          <section id="section10" ref={sectionRefs.section10} className={styles.section}>
            <h2 className={styles.sectionTitle}>10. Changes to Terms</h2>
            <p>We reserve the right, at our sole discretion, to modify or replace these Terms at any time. If a revision is material, we will provide at least 30 days' notice prior to any new terms taking effect. What constitutes a material change will be determined at our sole discretion.</p>
          </section>

          <section id="section11" ref={sectionRefs.section11} className={styles.section}>
